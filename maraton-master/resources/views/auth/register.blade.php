                        ...
                        @endif
                            ...
                            <div class="input-group">
                             ...
                             <div class="input-group">
                                ...
                                <input id="phone" type="phone" placeholder="Teléfono" class="form-control" name="phone" value="" required>
                            </div>
                            ...
                            <div class="input-group">
                                ...
                                <select class="form-control"  name="admin" id="admin" type="admin"  required>
